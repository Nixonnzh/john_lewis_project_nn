...
def sql_load_labels_on_sf():
    ...
    sql_file = r"C:\Users\NixonNg\OneDrive - Kubrick Group\Desktop\Kubrick Training Program\Week 14 (Client Project)\JLP\jlp_git_repo\BatterseaPowerStation\load_labels_on_sf.sql"
